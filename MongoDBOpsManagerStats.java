...
class MongoDBOpsManagerStats {
    ...
    Map<String, BigDecimal> populateMetrics() throws IOException {
        ...
        List<String> projectsFromCfg = (List) config.get("projects");
        String metricTemplateFromCfg = (String) config.get("metrictemplate");
        MongoDeploymentMetricManager mongoDeploymentMetricManager = new MongoDeploymentMetricManager(serverUrl, httpClient, metricTemplateFromCfg, databasesFromCfg, projectsFromCfg);
    ...
    void printMetrics(Map<String, BigDecimal> mongoDBMetrics) {
        ...
        for (Map.Entry<String, BigDecimal> metric : mongoDBMetrics.entrySet()) {
            ...
            metricValue = metricValue.setScale(0);
            if (metricValue != null) {
